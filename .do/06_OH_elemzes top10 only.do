...
//		regress o_zpsc_10 o_zpsc_8 i.sum10_F1 csh_index i.sum10_F1#c.csh_index, re cluster(omid10)
...
drop freq_omid10
	...
	regress o_zpsc_10  sum10 , cluster(omid) 
	outreg2 using ${stataOUT}tables/eredmenyek_`w'_top10only.tex", replace ctitle(E1) sortvar(`sortt') drop(`dropp') addtext(Wave, `w') tex(fragment pretty)
...
drop freq_omid10
		...
		regress o_zpsc_10  sum10 , cluster(omid) 
		outreg2 using ${stataOUT}tables/eredmenyek_`w'_top10only.tex", append ctitle(`v') sortvar(`sortt') drop(`dropp') addtext(Wave, `w') tex(fragment pretty)
		*drop sum10_1of5 sum10_2of5 sum10_3of5 sum10_4of5 sum10_5of5
		restore
	}
