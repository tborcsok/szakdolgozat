...
drop freq_omid10
	...
	xtreg o_zpsc_10  sum10 csh_index  sum10#c.csh_index i.nem, `ref' cluster(omid10)
	outreg2 using ${stataOUT}tables/eredmenyek_`w'_`ref'_szint.tex", replace ctitle(E1) sortvar(`sortt') drop(`dropp') addtext(Panel, `ref', Wave, `w') tex(fragment pretty)
...
drop freq_omid10
		...
		xtreg o_zpsc_10  sum10 csh_index  sum10#c.csh_index i.nem, `ref' cluster(omid10)
		outreg2 using ${stataOUT}tables/eredmenyek_`w'_`ref'_szint.tex", append ctitle(`v') sortvar(`sortt') drop(`dropp') addtext(Panel, `ref', Wave, `w') tex(fragment pretty)
		*drop sum10_1of5 sum10_2of5 sum10_3of5 sum10_4of5 sum10_5of5
		restore
	}
...
drop freq_omid10
	gen sum10 = (sum10_E1_lag >= 4) if sum10_E1_lag != .
	xtreg o_zpsc_10  sum10 csh_index  sum10#c.csh_index i.nem i.wave, `ref' cluster(omid10)
	outreg2 using ${stataOUT}tables/eredmenyek_`w'_`ref'_szint.tex", replace ctitle(E1) sortvar(`sortt') drop(`dropp') addtext(Panel, `ref', Wave, `w') tex(fragment pretty)
	*drop sum10_1of5 sum10_2of5 sum10_3of5 sum10_4of5 sum10_5of5
	restore
